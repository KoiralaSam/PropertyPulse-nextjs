...
const PropertyCard = ({ property, isAboveFold }) => {
      ...
      <div className="p-4">
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-4">
          ...
          <Link
            ...
            className="h-[36px] bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-center text-sm flex items-center"
          >
            Details
          </Link>
        </div>
